                        ...
                        <div class="card-header bg-primary mb-4">
                            ...
                            <div class="card-body">
                                <form>
                                    ...
                                    <div class="row ">
                                        <div class="col-lg-6">
                                        <label class="col-sm-2 col-form-label" for="basic-icon-default-fullname">School Type ID</label>
                                            <div class="col-sm-10">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                        <label class="col-sm-2 col-form-label" for="basic-icon-default-company">School Name</label>
                                            <div class="col-sm-10">
                                            <div class="input-group input-group-merge">
                                                    <span class="input-group-text"><i class="bx bx-year"></i></span>
                                                    <input
                                        ...
                                        <div class="col-lg-6">
                                        <label class="col-sm-2 col-form-label" for="basic-icon-default-fullname">Family BG ID</label>
                                            <div class="col-sm-10">
                                            <select name="" id="" class="form-select form-select mb-3" >
                                                <option selected disabled>--Select--</option>
                                            </select>
                                    ...
                                    <div class="row">
                                        ...
                                        <label class="col-sm-2 col-form-label" for="basic-icon-default-company">Father Name</label>
                                            <div class="col-sm-10">
                                            <div class="input-group input-group-merge">
                                                    <span class="input-group-text"><i class="bx bx-year"></i></span>
                                                    <input
                                        ...
                                        <label class="col-sm-2 col-form-label" for="basic-icon-default-company">Father Age</label>
                                            <div class="col-sm-10">
                                            <div class="input-group input-group-merge">
                                                    <span class="input-group-text"><i class="bx bx-year"></i></span>
                                                    <input
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-6">
                                        <label class="col-sm-2 col-form-label" for="basic-icon-default-fullname">Father Country</label>
                                            <div class="col-sm-10">
                                            <select name="" id="" class="form-select form-select mb-3" >
                                                <option selected disabled>--Select--</option>
                                            </select>
                                     ...
                                     <div class="row">
                                       ...
                                       <div class="col-lg-6">
                                            ...
                                            <label class="col-sm-2 col-form-label" for="basic-icon-default-company">Mother Name</label>
                                                <div class="col-sm-10">
                                                <div class="input-group input-group-merge">
                                                        <span class="input-group-text"><i class="bx bx-year"></i></span>
                                                        <input
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <label class="col-sm-2 col-form-label" for="basic-icon-default-company">Mother Age</label>
                                                <div class="col-sm-10">
                                                <div class="input-group input-group-merge">
                                                        <span class="input-group-text"><i class="bx bx-year"></i></span>
                                                        <input
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <label class="col-sm-2 col-form-label" for="basic-icon-default-company">Spouse Name</label>
                                                <div class="col-sm-10">
                                                <div class="input-group input-group-merge">
                                                        <span class="input-group-text"><i class="bx bx-year"></i></span>
                                                        <input
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <label class="col-sm-2 col-form-label" for="basic-icon-default-company">Spouse Age</label>
                                                <div class="col-sm-10">
                                                <div class="input-group input-group-merge">
                                                        <span class="input-group-text"><i class="bx bx-year"></i></span>
                                                        <input
                                    ...
                                    <div class="row justify-content-start mb-3">
                                        <div class="col-sm-10">
                                             <a type="submit" class="btn btn-outline-primary" href="steptree.php">Previus</a>
                                             <a type="submit" class="btn btn-primary" href="stepfive.php">Next</a>
